...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-03-2025 a las 01:08:19
...
(1, 'Entretenimiento', 'son las cosas que solo se usan en el tiempo libre'),
(2, 'salud', 'cosas destinadas a nuestro bienestar');
...
(1, 'la calle dondde vivo', 666, 'del rayo mcqueen', 5094, 'sinaloa', 'culiacan', 1);
...
INSERT INTO `lista_deseos` (`id`, `usuario_id`, `precio_id`) VALUES
(1, 1, 400);
...
(1, 'audifonos inalambricos', 'audifonos alambricos', 400, 1, 870);
...
(1, 'Cesar Alexis', 'Lopez Molina ', 'cesar.lopez23@cetis107.edu.mx', '6673084808', '2008-07-02', 0);
